                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            ...
                            <li><Link to="/collections/new" className="hover:text-foreground">New Arrivals</Link></li>
                            <li><Link to="/collections/bestsellers" className="hover:text-foreground">Bestsellers</Link></li>
                        </ul>
                    </div>
                    <div>
